...
// 收藏夹
export const DB_COLLECTIONS_HASH = 'db:collections'; // field=collectionId, value={ id, owner, name, cover, tags:[], summary, articles:[{articleId,collectedAt}], createdAt, updatedAt }
